...
export const updateFormContent = async (req, res) => {
...
export const getFormContent = async (req, res) => {
...
export const deleteFormElement = async (req, res) => {
    ...
    try {
        ...
        const newContent = content.filter((element) => element.id !== elementId);
        const updatedForm = await prisma.form.update({
            where: { userId, id },
